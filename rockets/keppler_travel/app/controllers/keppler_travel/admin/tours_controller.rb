...
module KepplerTravel
  module Admin
    ...
    class ToursController < ApplicationController
      ...
      def tour_params
        params.require(:tour).permit(:position, :deleted_at, :featured, :status, files:[], title: @language, description: @language, task: @language, price_adults: @currency, price_kids: @currency)
      end
