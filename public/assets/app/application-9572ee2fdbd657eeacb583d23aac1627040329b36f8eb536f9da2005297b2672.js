...
$(document).ready(function () {
  WebFontConfig = {
    google: {
      families: ['Poppins:100,200,300,400,500,600,700,800,900', 'Patua+One']
    }
  };
  (function () {
...
function validateReservationCircuit(id_form) {
  $(id_form).validate({
    event: "blur",
    ...
    submitHandler: function (form) {
      let ranking = ranking_id_radio;
      json_parse = JSON.parse(ranking_id_radio);

      $('form').append(`<input type="hidden" name="square_circuit[][ranking_id]" value=${json_parse['ranking_id']} /> `);
      // debugger;
      form.submit();
    }
