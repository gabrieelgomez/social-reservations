module App
  ...
  class ReservationsToursController < FrontController
    ...
    def create_reservation_tour
      ...
      @reservation.reservationable = KepplerTravel::Tour.find session[:tour]['id']
      build_invoice
      if @reservation.save!
        create_travellers
    ...
    def reservation_params
      params.require(:reservation).permit(:origin, :arrival, :origin_location, :arrival_location,
                                          ...
                                          :quantity_kit, :round_trip, :airport_origin,
