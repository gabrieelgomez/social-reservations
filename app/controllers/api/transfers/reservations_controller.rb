module Api
  module Transfers
    class ReservationsController < TransfersController
      ...
      def set_price
        ...
        if @user.is_from_colombia? || params[:reservationable][:cotization]
          @cotization  = true
          @price_total = 0
        else
      ...
      def reservation_params
        params.require(:reservation).permit(:origin, :arrival, :origin_location, :arrival_location, :reservation_mobile,
